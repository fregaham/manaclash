...
r = [
    ...
    R("ability", ["SELF can block an additional creature."], lambda t:TagAbility("can block an additional creature")),
    ...
    R("effect", [N("selector"), " ", N("deal"), " ", N("Number"), " damage to each ", N("selector"), "."], lambda t,x,d,n,y:XDealNDamageToY(x, y, n)),
    ...
    R("basicSelector", ["creatures with power ", Number, " or less"], lambda t,n:CreatureWithPowerNOrLessSelector(n)),
